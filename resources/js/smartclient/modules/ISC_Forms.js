...
if(this.isRequired(_16)&&!_10[_17]&&!_3){if(_18==null||isc.is.emptyString(_18)){_15=this.addValidationError(_10,_17,isc.Validator.requiredField);if(_15)_6=true}}
if(_19){if(_15)_11[_17]=_10[_17]}else if(_7==null&&_6)_7=_16;if(_13)delete _13[_17]}
if(_13){for(var i in _13){var _26=_13[i],_27=i,_20=_26.validators,_28=this.isRequired(_26),_18=_12[_27];if(_28&&_18==null){this.addValidationError(_10,_27,isc.Validator.requiredField)}else if(_20!=null){var _18=_12[_27];for(var i=0;i<_20.length;i++){var _22=_20[i];if(!_22)continue;if(_22.type!="requiredIf"&&_18==null){continue}
...
);isc.B._maxIndex=isc.C+213;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$450="id";isc.B.push(isc.A.getEditorType=function(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$12a){if(!this.canEditField(_1,_2))_5=this.$12a;else _5=this.$gx}else if(!this.canEditField(_1,_2)){if(_5==this.$12e||_5==this.$52x||_5==this.$677)
...
else _5=this.$12b}else if(isc.isA.DataSource(_3)&&_3.fieldIsComplexType(_1.name)){_5=_1.multiple?_2.nestedListEditorType:_2.nestedEditorType}else{if(!_1.type||(_1.type==_4)||(_1.type!=this.$12j&&(isc.FormItemFactory.getItemClass(_1.type)==null)))
...
);isc.evalBoundary;isc.B.push(isc.A.getHint=function(){if(!this.showHint||!this.hint)return null
return this.hint}
...
);isc.evalBoundary;isc.B.push(isc.A.resetToLastSelection=function(_1){if(!this.isDrawn()||this.$17r==null)return;var _2,_3=this.getElementValue(),_4=this.$17q;if(!_1)_2=(_3==_4);else{if(this.$17r==0&&this.$17s==_4.length){_2=true;this.$17s=_3.length}else{_2=(_3.toLowerCase()==_4.toLowerCase())}}
...
_6=_2.condition}
if(_6!=null){if(_1&&_1.multiple&&_1.validateEachItem&&isc.isAn.Array(_3)){var _7=[];for(var i=0;i<_3.length;i++){delete _2.resultingValue;_5=_5&&_6(_1,_2,_3[i]);_7[i]=(_2.resultingValue!=null?_2.resultingValue:_3[i])}
...
this.$72k(p);this.$72l[p]=c;this.$717(true);var _13=this.$72h(p);this.$72a(_13)}}}
return false}
...
,isc.A.mapDisplayToValue=function(_1){var _2=this.Super("mapDisplayToValue",arguments);if(isc.isAn.emptyString(_2)&&this.allowEmptyValue)_2=null;else{_2=isc.Time.parseInput(_2)}
return _2}
