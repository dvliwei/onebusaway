...
,isc.A.toLocalizedString=function(_1,_2,_3,_4){var _5=!_1?this:Math.round(this*Math.pow(10,_1))/Math.pow(10,_1);var _6=Math.abs(_5),_7=Math.floor(_6),_8,_9,_10=[];if(_1){var _11=Math.round((_6-_7)*Math.pow(10,_1));_9=_11.stringify(_1)}else if(_1==0){_7=Math.round(_6)}else{if(_6-_7>0){_9=_6.toString().split(this.$eh)[1]}}
...
,isc.A.compareLogicalDates=function(_1,_2){if(_1==_2)return 0;if(!isc.isA.Date(_1)||!isc.isA.Date(_2))return false;var _3=_1.getFullYear(),_4=_1.getMonth(),_5=_1.getDate(),_6=_2.getFullYear(),_7=_2.getMonth(),_8=_2.getDate();var _9=_3*10000+_4*100+_5,_10=_6*10000+_7*100+_8;return _9>_10?-1:(_10>_9?1:0)}
...
,isc.A.$68i=function(_1){if(!_1){var _2=this.$68f;_2[0]=this.getHours().stringify();_2[1]=this.getMinutes().stringify();return _2.join(":")}else{return isc.Time.toShortTime(this,"toShortPadded24HourTime")}}
...
,isc.A.$qd=function(){var _1=this.accessKey;if(!_1||!this.isDrawn()||!this.$kk())return;var _2=this.$qs("focusProxy");var _3=isc.StringBuffer.concat("<a id='",_2,"' href='javascript:void(0)","' onfocus='var _0=window.",this.getID(),";if(_0){_0.focus()}' ","accessKey='"+_1+"'></a>");isc.Element.insertAdjacentHTML(this.getClipHandle(),"beforeEnd",_3);this.$qt=isc.Element.get(_2)}
...
);isc.evalBoundary;isc.B.push(isc.A.getOverflow=function(){return this.overflow}
...
,isc.A.$73v=function(){var _1=!this.$r3&&!isc.Browser.isOpera&&!((isc.Browser.isSafari||isc.Browser.isFirefox)&&this.containsIFrame());return _1?isc.Canvas.$oz:null}
,isc.A.$73w=function(){var _1=this.$73v();if(_1!=this.$73u)
...
if(!isc.PrintWindow)return;_3=isc.addProperties({width:"100%",height:"100%",autoDraw:false},_3);if(!this.$57i){this.$57i=isc.PrintWindow.create(_3)}else{this.$57i.resizeTo("100%","100%")}
...
,isc.A.getDataPathField=function(_1){var _2=this.getDataSource(),_3=_1.split(isc.slash),_4;if(!_2)return;for(var i=0;i<_3.length;i++){var _6=_3[i];_4=_2.getField(_6);_2=_4?_2.getSchema(_4.type):_2;if(_4==null){this.logWarn("Unable to find dataSource field matching specified dataPath: '"+_1+"'");return}}
return _4}
...
,isc.A.bindToDataSource=function(_1,_2){if(this.dataPath)this.setDataPath(this.dataPath);if(this.dataSource==null&&this.data!=null)this.dataSource=this.data.dataSource;var _3=this.fields||this.items;if(isc.isAn.Array(_3))this.originalFields=_3.duplicate();var _4=this.getDataSource();if(_4!=null&&isc.isA.String(_4)){this.logWarn("unable to look up DataSource: "+_4+", databinding will not be used");return _1}
...
if(_4==null||_6==null){if(_1!=null&&isc.SimpleType){for(var i=0;i<_1.length;i++){isc.SimpleType.addTypeDefaults(_1[i])}}
return _1}
...
return _1}
if(_4!=null&&!_5){if(this.useAllDataSourceFields){var _11=this;return _4.combineFieldOrders(_6,_1,function(_10,_4){return _11.shouldUseField(_10,_4)})}else{for(var i=0;i<_1.length;i++){var _10=_1[i];if(!_10)continue;var _9=_10[this.fieldIdProperty];isc.SimpleType.addTypeDefaults(_10);_10=this.combineFieldData(_10)}
return _1}}}
...
,isc.A.addField=function(_1,_2){var _3=(this.fields||this.items||isc.$ac).duplicate();if(_2==null)_2=_3.length;_3.addAt(_1,_2);this.setFields(_3)}
,isc.A.removeField=function(_1){var _2=(this.fields||this.items||isc.$ac).duplicate();var _3=_1.name?_1.name:_1;_2.remove(_2.find("name",_3));this.setFields(_2)}
,isc.A.setCanEdit=function(_1){this.canEdit=_1}
...
if(!this.exportAll&&!_1.exportFields){var _3=this.exportFields;if(!_3){_3=[];for(var i=0;i<this.fields.length;i++){var _5=this.fields.get(i);if(this.$71s(_5)){_3.add(_5.name);if(_5.displayField&&!_5.optionDataSource)_3.add(_5.displayField)}}}
...
,isc.A.removeSelectionMarkers=function(_1){var _2=true;if(!isc.isAn.Array(_1)){_1=[_1];_2=false}
...
,isc.A.addHiliteCSSText=function(_1,_2,_3){if(!_1)return _3;var _4=_1[this.hiliteMarker],_5=this.getField(_2);if(!_5.$58c)return _3;var _6=_5.$58c[_4];if(_6==null)return _3;if(!isc.isAn.Array(_6)){this.$579[0]=_6;_6=this.$579}
...
);isc.evalBoundary;isc.B.push(isc.A.getFormulaFieldValue=function(_1,_2){return this.getFormulaFunction(_1)(_2,this)}
...
,isc.A.userFieldCallback=function(_1){if(!_1)return;var _2=this.$65y;if(_1.cancelled){_2.destroy();return}
...
,isc.A.getRecordHiliteCSSText=function(_1,_2,_3){var _4=_2;if(_4==null)_4="";if(_3.userSummary!=null&&_3.userSummary.summaryVars!=null){var _5=isc.SummaryBuilder.getUsedFieldsFromValue(_3.userSummary.summaryVars,this.getAllFields(),this);for(var i=0;i<_5.length;i++){_4=this.getRecordHiliteCSSText(_1,_4,_5[i])}}
_4=this.addObjectHilites(_1,_4,_3);_4=this.addHiliteCSSText(_1,this.getFieldNum(_3),_4);if(_4&&_4!=(_2||""))return _4;return _2}
,isc.A.convertCSSToProperties=function(_1){var _2=[{propName:"backgroundColor",re:/background-color:([^;]*);?/},{propName:"backgroundImage",re:/background-image:([^;]*);?/},{propName:"backgroundPosition",re:/background-position:([^;]*);?/},{propName:"backgroundRepeat",re:/background-repeat:([^;]*);?/}];var _3=null;_1=_1||"";if(_1!="")for(var i=0;i<_2.length;i++){var _5=_2[i];var _6=_1.match(_5.re);if(_6!=null){_1=_1.replace(_5.re,function(_7,_8,_9,_10){if(!_3)_3={};_3[_5.propName]=_8;return""})}}
if(_1){if(!_3)_3={};_3.cssText=_1}
return _3}
,isc.A.getClientExportSummaryFunction=function(_1){if(!_1.userSummary)return null;var _2=_1.$73i;if(_2!=null)return _2;var _3=this.generateFunctionCore(_1.userSummary,this.getAllFields(),this,"'},{value:","},{value:'","{value:'","'}",function(_4){if(_4.substr(0,3)=="{")_4=_4.substr(3);if(_4.substr(_4.length-3)=="+'''")
_4=_4.substr(0,_4.length-3)});_2=_1.$73i=isc.SummaryBuilder.generateFunction(_1.userSummary,this.getAllFields(),this);return _2}
,isc.A.generateClientExportSummaryFunctions=function(){var _1=0,f;var _3=this;var _4=this.getAllFields();while((f=_4[_1++])!=null)
if(f.type=="summary"&&f.userSummary!=null)
f.$73i=isc.SummaryBuilder.generateFunctionCore(f.userSummary,this.getAllFields(),this,function(_7,_8){return"'},{value:"+_8+",cssText:((record[component.hiliteMarker]!=null&&component.getField('"+_7.name+"').$58c!=null)?"+"component.getHilite(component.getField('"+_7.name+"').$58c[record[component.hiliteMarker]]).cssText:null)},{value:'"},function(_7){_7="[{value:'"+_7+"'}]";var _5="[{value:''},",_6=",{value:''}]";if(_7.substr(0,_5.length)==_5)
_7="["+_7.substr(_5.length);if(_7.substr(_7.length-_6.length)==_6)
_7=_7.substr(0,_7.length-_6.length)+"]";return _7})}
,isc.A.transformExportRecord=function(_1,_2,_3){var i=0,f,_6={};var _7=0;var _8=this.getAllFields();while((f=_8[_7++])!=null){if(!(this.fieldIsVisible&&!this.fieldIsVisible(f))||_3){if(f.type=="summary"&&f.userSummary!=null){var v=f.$73i(_1,f.name,this);for(var k=0;k<v.length;k++)
if(v[k].cssText==null)delete v[k].cssText;_6[f.name]=this.getSummaryFieldValue(f,_1);for(var k=0;k<v.length;k++){isc.addProperties(v[k],this.convertCSSToProperties(v[k].cssText))}
_6[f.name+"$style"]=v}else{var _11=this.getRawCellValue(_1,_2,f.name,true);if(_11!=null){_6[f.name]=_11;var _12=this.getRecordHiliteCSSText(_1,null,f);if(_12)_6[f.name+"$style"]=isc.addProperties({value:_11},this.convertCSSToProperties(_12))}}}}
return _6}
,isc.A.getClientExportData=function(_1){var _2,_3;var d=this.originalData||this.data;if(isc.isA.ResultSet(d)){_2=d.getLength();for(var i=0,_3=0;i<_2;i++)
if(d.rowIsLoaded(i))_3++}else if(isc.isA.Array(d))
_2=_3=d.length;else{isc.logWarn("unknown this.data type.");return}
this.generateClientExportSummaryFunctions();var _6=new Array(_3);var i=0,j=0,_8;for(var i=0,j=0;j<_3&&i<_2;i++){var _9;if(isc.isA.ResultSet(d)){if(d.rowIsLoaded(i))_9=d.get(i);else continue}else _9=d[i];_6[j++]=this.transformExportRecord(_9,i,_1)}
return _6}
,isc.A.getSort=function(){return this.$73p?isc.shallowClone(this.$73p):[]}
,isc.A.setSort=function(_1){this.$73p=isc.shallowClone(_1);if(this.data&&this.$73p&&this.$73p.length>0){if(this.data.setSort)this.data.setSort(this.$73p);else if(this.data.sortByProperty){var _2=this.$73p[0];this.data.sortByProperty(_2.property,Array.shouldSortAscending(_2.direction),_2.normalizer,_2.context)}}}
);isc.B._maxIndex=isc.C+125;isc.ClassFactory.defineClass("MathFunction","Class");isc.A=isc.MathFunction;isc.A.$65z={};isc.A=isc.MathFunction;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.registerFunction=function(_1){if(!this.$65z[_1.name]){this.$65z[_1.name]=_1}}
...
return _4}
,isc.A.getLocatorCanvas=function(_1){if(_1==null||isc.isAn.emptyString(_1))return null;var _2=_1.split("/"),_3;var _4=_2[2];var _5=_2.length;for(var i=3;i<_5;i++){_2[i-3]=_2[i]}
_2.length=_5-3;if(!_4)return null;var _7=this.getComponentFromLocatorSubstring(_4);if(_7){var i=0,_8=_7.getChildFromLocatorSubstring(_2[i]);while(_8!=null){i++;_7=_8;_8=_7.getChildFromLocatorSubstring(_2[i])}
return _7}
return null}
,isc.A.getLocatorFormItem=function(_1){if(_1==null||isc.isAn.emptyString(_1))return null;var _2=_1.split("/"),_3;var _4=_2[2];var _5=_2.length;for(var i=3;i<_5;i++){_2[i-3]=_2[i]}
_2.length=_5-3;if(!_4)return null;var _7=this.getComponentFromLocatorSubstring(_4);if(_7){var _8=_7.getChildFromLocatorSubstring(_2[0]);while(_8!=null){_2.removeAt(0);_7=_8;_8=_7.getChildFromLocatorSubstring(_2[0])}}
if(isc.isA.DynamicForm(_7)){return _7.getItemFromSplitLocator(_2)}
return null}
);isc.B._maxIndex=isc.C+6;isc.ApplyAutoTestMethods=function(){isc.Canvas.addMethods({getLocator:function(_15){var _1,_2;if(this._generated||this.locatorParent||this.creator||this.$541){_2=this.getLocatorParent()}
...
return this.locatorRoot},containsLocatorChild:function(_81){return false},getLocatorParent:function(){if(this.locatorParent&&this.locatorParent.containsLocatorChild(this)){return this.locatorParent}
...
return this.masterElement||this.parentElement},$55a:[,"[",,'][Class="',,'"]'],getChildLocator:function(_81){if(_81==this.hscrollbar){return"hscrollbar"}
if(_81==this.vscrollbar){return"vscrollbar"}
if(_81.creator==this){var _4=this.getAutoChildLocator(_81);if(_4)return _4}
return this.getStandardChildLocator(_81)},getAutoChildLocator:function(_81){if(this.$542){for(var _5 in this.$542){if(_81==this[_5])return _5}}
return null},getStandardChildLocator:function(_81){var _6=this.$55a;if(_81.masterElement==this){_6[0]="peer";_6[2]=this.peers.indexOf(_81)}else if(_81.parentElement==this){_6[0]="child";_6[2]=this.children.indexOf(_81)}else{this.logWarn("unexpected error - failed to find relationship between parent:"+this.getID()+" and child:"+_81.getID());return _81.getLocatorRoot()}
_6[4]=_81.getClassName();return _6.join(isc.emptyString)},getInteriorLocator:function(_15){if(_15&&this.useEventParts){var _7=this.getElementPart(_15);if(_7!=null&&_7.part!=null){return(_7.partID&&_7.partID!=isc.emptyString)?_7.part+"_"+_7.partID:_7.part}}
return isc.emptyString},getElementFromSplitLocator:function(_81){var _8=this.getChildFromLocatorSubstring(_81[0]);if(_8){_81.removeAt(0);return _8.getElementFromSplitLocator(_81)}
return this.getInnerElementFromSplitLocator(_81)},getChildFromLocatorSubstring:function(_81){if(_81==null)return null;if(isc.isA.Canvas(this[_81]))return this[_81]
var _8;for(var _9 in this.$558){_8=this.$559(_81,_9,this.$558[_9]);if(_8)break}
return _8},$558:{peer:"peers",child:"children"},$559:function(_81,_9,_82){if(_81.startsWith(_9+"[")){var _10=_81.match(_9+"\\[(\\d+)\\]\\[Class=\"(.+)\"\\]"),_11=_10?_10[1]:null,_12=_10?_10[2]:null;_11=parseInt(_11);if(!isc.isA.Number(_11)){this.logWarn("AutoTest.getElement() - didn't understand locator substring:"+_81);return null}
if(!this[_82]||!this[_82][_11]){this.logWarn("AutoTest.getElement(): unable to find "+_9+":"+_81);return null}
if(!isc.isA[_12]||!isc.isA[_12](this[_82][_11])){this.logWarn("AutoTest.getElement(): locator substring:"+_81+" gave component of class:"+this[_82][_11].getClassName())}
return this[_82][_11]}
return null},getInnerElementFromSplitLocator:function(_81){if(_81){if(_81.length==1){var _13=_81[0].split("_");var _14={part:_13[0],partID:_13[1]};var _15=this.getPartElement(_14);if(_15)return _15}}
return this.getHandle()}});if(isc.Layout){isc.Layout.addProperties({getStandardChildLocator:function(_81){var _16=this.members?this.members.indexOf(_81):-1;if(_16!=-1){var _6=this.$55a;_6[0]="member";_6[2]=_16;_6[4]=_81.getClassName();return _6.join(isc.emptyString)}
return this.invokeSuper(isc.Layout,"getStandardChildLocator",_81)},$558:{member:"members",peer:"peers",child:"children"}})}
if(isc.Window){isc.Window.addProperties({containsLocatorChild:function(_81){return(this.items&&this.items.contains(_81))},getStandardChildLocator:function(_81){if(this.items&&this.items.contains(_81)){var _6=this.$55a;_6[0]="item";_6[2]=this.items.indexOf(_81);_6[4]=_81.getClassName();return _6.join(isc.emptyString)}
return this.invokeSuper(isc.Window,"getStandardChildLocator",_81)},$558:{item:"items",member:"members",peer:"peers",child:"children"}})}
if(isc.SectionStack){$55b:["section[",,"]/item[",,'][Class="',,'"]'],isc.SectionStack.addProperties({getStandardChildLocator:function(_81){var _17=this.sections?this.sections.indexOf(_81):-1;if(_17!=-1){var _6=this.$55a;_6[0]="section";_6[2]=_17
_6[4]=_81.getClassName();return _6.join(isc.emptyString)}
var _18=this.sections||[];for(var i=0;i<_18.length;i++){var _20=_18[i].items,_21=_20?_20.indexOf(_81):-1;if(_21!=-1){var _6=this.$55b;_6[2]=i;_6[3]=_21;_6[5]=_81.getClassName();return _6.join(isc.emptyString)}}
return this.invokeSuper(isc.Window,"getStandardChildLocator",_81)},$558:{section:"sections",member:"members",peer:"peers",child:"children"},getChildFromLocatorSubstring:function(_81){if(isc.isA.Canvas(this[_81]))return this[_81]
var _10=_81.match("section\\[(\\d+)\\]/item\\[(\\d+)\\]\\[Class=\"(.+)\"\\]");if(_10){var _17=_10[1],_21=_10[2],_12=_10[3];_17=parseInt(_17);_21=parseInt(_21);if(!isc.isA.Number(_17)||!isc.isA.Number(_21)){this.logWarn("AutoTest.getElement() - didn't understand locator substring:"+_81);return null}
if(!this.sections||!this.sections[_17]||!this.sections[_17].items||!this.sections[_17].items[_21])
{this.logWarn("AutoTest.getElement(): unable to find section "+_17+", item:"+_21+" requested by locator:"+_81);return null}
var _22=this.sections[_17].items[_21];if(!isc.isA[_12]||!isc.isA[_12](_22)){this.logWarn("AutoTest.getElement(): locator substring:"+_81+" gave component of class:"+_22.getClassName())}
return _22}
var _8;for(var _9 in this.$558){_8=this.$559(_81,_9,this.$558[_9]);if(_8)break}
return _8}})}
...
_15=_15.parentNode}
return this.Super("getInteriorLocator",[_23])},getInnerElementFromSplitLocator:function(_81){if(_81&&_81.length==1){var _27=this.getImage(_81[0]);if(_27)return _27}
...
return _29.join(isc.emptyString)},containsLocatorChild:function(_81){if(isc.isA.DateChooser(_81)&&_81.callingForm==this)return true;return this.Super("containsLocatorChild",arguments)},getChildLocator:function(_81){if(_81.canvasItem){var _22=_81.canvasItem;return["item[",(_22.name?"name='"+_22.name+"'":"index='"+this.items.indexOf(_22)+"'"),'][Class="',_22.getClassName(),'"]/',"canvas"].join(isc.emptyString)}
if(isc.isA.PickListMenu(_81)){var _22=_81.formItem;return["item[",(_22.name?"name='"+_22.name+"'":"index='"+this.items.indexOf(_22)+"'"),'][Class="',_22.getClassName(),'"]/',"pickList"].join(isc.emptyString)}
if(isc.isA.DateChooser(_81)){var _22=_81.callingFormItem;return["item[",(_22.name?"name='"+_22.name+"'":"index='"+this.items.indexOf(_22)+"'"),'][Class="',_22.getClassName(),'"]/',"picker"].join(isc.emptyString)}
return this.Super("getChildLocator",arguments)},getItemFromSplitLocator:function(_81){var _30=_81[0],_31=_30.contains("name="),_10=_30.match("item\\["+(_31?"name='":"index='")+"(.+)'\\]\\[Class=\"(.+)\"\\]");if(_10){var _32=_10[1],_33=_10[2];var _22=this.getItem(_32);if(!_22){this.logWarn("AutoTest.getElement(): Unable to find item with identifier"+_32+", from locator:"+_30);return null}
...
return _22}
return null},getInnerElementFromSplitLocator:function(_81){if(!_81||_81.length==0){return this.getHandle()}
var _22=this.getItemFromSplitLocator(_81);if(_22!=null){_81.removeAt(0);return _22.getInnerElementFromSplitLocator(_81)}
return this.getHandle()}});isc.FormItem.addProperties({getInnerElementFromSplitLocator:function(_81){if(_81&&_81.length>0){var _14=_81[0];if(_14=="element")return this.getDataElement();if(_14=="title")return this.form.getTitleCell(this);if(_14=="textbox")return this.$15h();if(_14=="controltable")return this.$56a();if(_14=="canvas"){if(this.canvas){_81.removeAt(0);return this.canvas.getElementFromSplitLocator(_81)}}
if(_14=="picker"){if(this.picker){_81.removeAt(0);return this.picker.getElementFromSplitLocator(_81)}}
if(_14=="pickList"){if(!this.pickList)this.makePickList(false);_81.removeAt(0);return this.pickList.getElementFromSplitLocator(_81)}
...
_46=_45+(this.$252||0)
_49=_48+(this.$254||0);return"row"+_46+"/col"+_49},getInnerElementFromSplitLocator:function(_81){if(!_81||_81.length==0)return this.getHandle();if(_81.length==2){var _45=parseInt(_81[0].substring(3)),_48=parseInt(_81[1].substring(3));if(isc.isA.Number(_45)&&isc.isA.Number(_48)){if(this.$29p())return null;return this.getTableElement(_45,_48)}}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.ListGrid){isc.ListGrid.addProperties({containsLocatorChild:function(_81){if(_81==this.body||_81==this.frozenBody||_81==this.$286)
{return true}
return this.Super("containsLocatorChild",arguments)},getStandardChildLocator:function(_81){if(_81==this.body)return"body";if(_81==this.frozenBody)return"frozenBody";if(_81==this.$286)return"$286";return this.Super("getStandardChildLocator",arguments)}})}
...
_15=_15.parentNode}
return this.Super("getInteriorLocator",[_23])},getInnerElementFromSplitLocator:function(_81){if(!_81||_81.length==0)return this.getHandle();if(_81.length==3&&_81[2]=="open"){if(this.$29p())return null;var _45=parseInt(_81[0].substring(3)),_48=parseInt(_81[1].substring(3));var _52=this.grid.$34l+_45,_27=this.grid.getImage(_52);if(_27)return _27}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.StatefulCanvas){isc.StatefulCanvas.addProperties({getInnerElementFromSplitLocator:function(_81){if(_81&&this.label){return this.label.getInnerElementFromSplitLocator(_81)}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.DateChooser){isc.DateChooser.addMethods({getInteriorLocator:function(_15){var _24=this.getHandle();if(!_24||!_15)return"";var _53=_15.$73l;if(_53!=null&&_53!="")return _53;return _15.$73l=this.$73m(_15,_24)},$73m:function(_15,_24){var _54=_15;while(_54&&_54!=null){if(_54==_24){_54=null;break}
if(_54.tagName&&_54.tagName.toLowerCase()=="td"){break}
_54=_54.parentElement}
if(_54==null)return"";var _55=_24.childNodes,_56=[];for(var i=0;i<_55.length;i++){if(!_55[i].tagName||_55[i].tagName.toLowerCase()!="table"){continue}
_56[_56.length]=_55[i]}
var _57=_56.length==2?_56[0]:null,_58=_56.length==2?_56[1]:_56[0];if(_57!=null&&_54.offsetParent==_57){var _59=_54.onclick,_60=_59?_59.toString():null;if(!_60)return"";if(_60.contains("showPrevYear")){return"prevYearButton"}else if(_60.contains("showNextYear")){return"nextYearButton"}else if(_60.contains("showPrevMonth")){return"prevMonthButton"}else if(_60.contains("showNextMonth")){return"nextMonthButton"}else if(_60.contains("showMonthMenu")){return"monthMenuButton"}else if(_60.contains("showYearMenu")){return"yearMenuButton"}
return""}else if(_58!=null&&_54.offsetParent==_58){var _59=_54.onclick,_60=_59?_59.toString():null;if(!_60)return"";if(_60.contains("cancelClick"))return"cancelButton";else if(_60.contains("todayClick"))return"todayButton";else{var _61=_60.match("dateClick\\(\(.*\)\\)");if(_61&&_61[1]){var _62=_61[1].split(",");for(var i=0;i<_62.length;i++){_62[i]=_62[i].trim()}
return _62.join("/")}}}
return""},getInnerElementFromSplitLocator:function(_81){if(!_81||_81.length==0)return this.getHandle();var _24=this.getHandle();if(_24==null)return;var _63=(_81.length==3);if(!_63){var _64=_81[0];if(_64=="")return _24;var _65=(_64=="todayButton"),_66=!_65?(_64=="cancelButton"):false;var _55=_24.childNodes;if(_65||_66){if(_65&&!this.showTodayButton){this.logWarn("DateChooser attempting to locate element for "+"'todayButton' but showTodayButton is false. Returning handle.","AutoTest");return _24}
if(_66&&!this.showCancelButton){this.logWarn("DateChooser attempting to locate element for "+"'cancleButton' but showCancelButton is false. Returning handle.","AutoTest");return _24}
var _58;for(var i=_55.length-1;i>=0;i--){if(_55[i].tagName&&_55[i].tagName.toLowerCase()=="table")
{_58=_55[i];break}}
var _67=_58.rows[_58.rows.length-1],_47=_67.cells;for(var i=0;i<_47.length;i++){if(this.getInteriorLocator(_47[i])==_64){return _47[i]}}}else{if(!this.showHeader){this.logWarn("DateChooser attempting to locate element for "+_81+" but this.showHeader is false so this element will not be present. "+"Returning handle.","AutoTest");return _24}
var _57
for(var i=0;i<_55.length;i++){if(_55[i].tagName&&_55[i].tagName.toLowerCase()=="table")
{_57=_55[i];break}}
var _39=_57.rows[0],_47=_39.cells;for(var i=0;i<_47.length;i++){if(this.getInteriorLocator(_47[i])==_64){return _47[i]}}}}else{var _68=_81[0],_69=_81[1],_70=_81[2];if((_68==this.year)&&(this.month==_69||this.month==_69+1||this.month==_69-1))
{var _71=new Date(_68,_69,_70),_72=_71.getDay();if(this.showWeekends||!Date.getWeekendDays().contains(_72)){var _73=new Date(this.year,this.month,1);var _74=_73.getDay(),_75=_74+this.firstDayOfWeek-
(_74<this.firstDayOfWeek?7:0);_73.setDate(_73.getDate()-_75);if(Date.compareDates(_71,_73)!=1){var _76=new Date(this.year,this.month+1,1);_76.setTime(_76.getTime()-86400000);var _77=_76.getDay(),_78=this.firstDayOfWeek+6;if(_78>6)_78-=7;var _79=_78>_77?_78-_77:_78+7-_77;if(_79!=0){_76.setTime(_76.getTime()+(86400000*_79))}
if(Date.compareDates(_71,_76)!=-1){var _45=Math.floor(((parseInt(_70)+_75)/7))
_45+=1;var _80=this.firstDayOfWeek;if(!this.showWeekends){while(Date.getWeekendDays().contains(_80)){_80+=1;if(_80==7)_80=0}}
var _48=_71.getDay()-(_80+_75);if(_48<0)_48+=7;_48-=1;var _55=_24.childNodes,_58;for(var i=_55.length-1;i>=0;i--){if(_55[i].tagName&&_55[i].tagName.toLowerCase()=="table")
{_58=_55[i];break}}
if(_58)return _58.rows[_45].cells[_48]}else{this.logInfo("DateChooser Passed ID for a date after end. "+"end date:"+[_76.getFullYear(),_76.getMonth(),_76.getDay()]+" vs:"+[_68,_69,_70],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a date before start date. "+"startDate:"+[_73.getFullYear(),_73.getMonth(),_73.getDay()]+" vs:"+[_68,_69,_70],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a weekend - not showing weekends","AutoTest")}}else{this.logInfo("DateChooser passed ID for the wrong year or month - passed:"+_81+", showing:"+[this.year,this.month],"AutoTest")}
this.logWarn("DateChooser - passed inner locator for date ("+_81.join("/")+") -- not currently showing this date.","AutoTest")}
this.logWarn("DateChooser, unable to find element for inner locator:"+_81+" returning handle");return _24}})}}
